...
export const HeroSection = ({ isAuthenticated, loginWithDiscord }: HeroSectionProps) => {
  ...
  return (
    <section className="border-b border-slate-200 bg-gradient-to-br from-sky-50 via-white to-indigo-50 dark:bg-none dark:bg-[#0b1120] dark:border-slate-800 dark:[background-image:none]">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-12 px-6 py-20 text-center md:flex-row md:items-center md:text-left">
        ...
        <div className="flex-1">
          <motion.div
            className="mx-auto max-w-md rounded-3xl border border-sky-100 bg-white/80 p-4 shadow-xl shadow-sky-100 dark:bg-slate-900 dark:border-slate-700 dark:shadow-none"
          ...
          >
            ...
            <div className="h-40 rounded-2xl bg-gradient-to-br from-sky-50 via-white to-indigo-50 p-4 text-left text-xs text-slate-700 dark:bg-none dark:bg-slate-800 dark:text-slate-300">
