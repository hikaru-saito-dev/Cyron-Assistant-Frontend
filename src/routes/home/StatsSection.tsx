...
export const StatsSection = () => {
  ...
  return (
    <section className="border-b border-slate-200 bg-gradient-to-br from-sky-50 via-white to-indigo-50 text-slate-900 dark:bg-none dark:bg-[#0b1120] dark:border-slate-800 dark:text-slate-100">
      <div className="mx-auto max-w-6xl px-6 py-16">
        ...
        >
          <motion.div
            className="rounded-2xl border border-sky-200 bg-white px-5 py-6 shadow-lg text-center dark:bg-slate-900 dark:shadow-none"
            variants={{
          ...
          <motion.div
            className="rounded-2xl border border-cyan-200 bg-white px-5 py-6 shadow-lg text-center dark:bg-slate-900 dark:shadow-none"
            variants={{
              hidden: { opacity: 0, y: 40 },
              visible: { opacity: 1, y: 0 },
            }}
          ...
          <motion.div
            className="rounded-2xl border border-indigo-200 bg-white px-5 py-6 shadow-lg text-center dark:bg-slate-900 dark:shadow-none"
            variants={{
              hidden: { opacity: 0, y: 40 },
              visible: { opacity: 1, y: 0 },
            }}
          ...
          <motion.div
            className="rounded-2xl border border-amber-200 bg-white px-5 py-6 shadow-lg text-center dark:bg-slate-900 dark:shadow-none"
            variants={{
              hidden: { opacity: 0, y: 40 },
              visible: { opacity: 1, y: 0 },
            }}
