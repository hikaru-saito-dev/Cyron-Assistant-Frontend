  ...
  return (
    <section className="bg-white dark:bg-[#0b1120]">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="flex flex-col items-center justify-between gap-6 rounded-2xl border border-slate-200 bg-slate-50 px-6 py-8 text-center md:flex-row md:text-left dark:bg-slate-900 dark:border-slate-700">
          <div>
