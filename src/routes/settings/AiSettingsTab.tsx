...
export const AiSettingsTab = ({
  ...
  const stepTitles = [
    "Core Identity", "Primary Goal", "Target Audience", "Tone & Style",
    "Greeting Message", "Knowledge Boundaries", "Fallback Strategy",
    "Formatting Rules", "Emoji Usage", "Custom Instructions", "Review & Finalize"
  ];
  ...
  return (
    ...
    >
          ...
          >
            <motion.div
              whileHover={{ y: -1 }}
              className="cyron-glass cyron-glass-hover p-6"
            >
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <button type="button" className="rounded-xl bg-[#F5A623] px-4 py-2 text-[13px] font-semibold text-white hover:bg-[#F5A623]/90 transition-colors shadow-lg shadow-[#F5A623]/20 disabled:opacity-50" onClick={handleSavePrompt} disabled={updateGuildPending || guildLoading}>
              ...
              <textarea
                ...
                className="min-h-[160px] w-full rounded-xl border border-white/10 bg-black/20 px-4 py-3 text-[13px] leading-relaxed text-white placeholder-slate-500 focus:border-[#F5A623]/50 focus:outline-none focus:ring-2 focus:ring-[#F5A623]/20"
              ...
              <div className="mt-5">
                ...
                <select
                  ...
                  className="w-full max-w-xs rounded-xl border border-white/10 bg-[#0f0f0f] px-4 py-2.5 text-[14px] text-white focus:border-[#F5A623]/50 focus:outline-none focus:ring-2 focus:ring-[#F5A623]/20 appearance-none"
                >
                  {TONES.map((t) => (
              ...
              <div className="mt-5">
                ...
                {testReply && (
                  <motion.div
                    ...
                    className="mt-3 rounded-xl border border-[#F5A623]/30 bg-[#F5A623]/10 p-4 text-[13px] text-white shadow-lg shadow-[#F5A623]/5"
                  >
                    <p className="text-[11px] font-bold uppercase tracking-wider text-[#F5A623]">Sample AI reply (simulation)</p>
