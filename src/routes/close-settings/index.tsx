    ...
    <div className="space-y-8 max-w-5xl mx-auto pb-12 pt-4 md:pt-0">
      <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between px-4 md:px-0">
        <div className="space-y-2">
          <TextBlurIn className="text-white font-bold uppercase text-[2.5rem] md:text-[3.5rem] leading-[0.85] tracking-tighter font-display">Close Settings</TextBlurIn>
        ...
        <button onClick={() => saveMut.mutate()} disabled={saveMut.isPending}
          className="shrink-0 cyron-btn-primary !px-5 !py-2 !text-[13px] disabled:opacity-50 inline-flex items-center gap-2">
