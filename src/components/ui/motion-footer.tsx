...
export function CinematicFooter({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Create a resize observer to refresh ScrollTrigger when document height changes
      // This is crucial for React SPAs where content can swap and change page height without a window resize event
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                ...
                <MagneticButton as="a" href="mailto:support@cyron.ai" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  Support
                </MagneticButton>
              </div>
            </div>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 order-2 md:order-1">
              <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest">
                © 2026 Cyron Assistant. All rights reserved.
              </div>
              <div className="flex items-center gap-6 text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest">
                <a href="mailto:support@cyron.ai" className="flex items-center gap-2 hover:text-foreground transition-colors">
