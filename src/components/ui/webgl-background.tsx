...
export function WebGLBackground() {
  ...
  useEffect(() => {
    ...
    const loop = (time: number) => {
      ...
      gl.uniform4f(uniforms.u_scene, canvas.width, canvas.height, t * 0.76, 4.0);
      gl.uniform4f(uniforms.u_shape, 1.68, 0.72, 0.50, 0.00);
      gl.uniform4f(uniforms.u_surface, 2.40, 1.08, 0.00, 1.00);
      gl.uniform4f(uniforms.u_finish, 0.00, 0.00, 0.000, 0.08);
      gl.uniform4f(uniforms.u_transform, 8617.0, 0.00, 0.00, 0.0);
      gl.uniform4f(uniforms.u_space, 0.00, 0.00, 0, 0); // Cursor: off
      gl.uniform4f(uniforms.u_cursor, 0.0, 2.0, 0.65, 0.46);
