...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  className,
  logoUrl = '/src/assets/logos/react-gh-white.svg',
  menuButtonColor = '#fff',
    ...
    >
      ...
      >
        ...
        <aside
          ...
          style={{ WebkitBackdropFilter: 'blur(12px)', backgroundColor: '#ffffff' }}
          aria-hidden={!open}
        >
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #ffffff !important; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; pointer-events: auto; }
